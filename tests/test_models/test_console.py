...
class TestHBNBCommand(unittest.TestCase):
    ...
    def test_db_create(self):
        ...
        with patch('sys.stdout', new=StringIO()) as cout:
            ...
            clear_stream(cout)
            cons.onecmd('create User email="dominicnjoroge1@gmail.com" password="123@Pasword_w"')
            mdl_id = cout.getvalue().strip()
            dbc = MySQLdb.connect(
            ...
            self.assertIn('dominicnjoroge1@gmail.com', result)
            self.assertIn('123@Pasword_w', result)
            cursor.close()
            dbc.close()
    ...
    def test_db_show(self):
        ...
        with patch('sys.stdout', new=StringIO()) as cout:
            ...
            obj = User(email="dominicnjoroge1@gmail.com", password="123@Pasword_w")
            dbc = MySQLdb.connect(
                host=os.getenv('HBNB_MYSQL_HOST'),
                port=3306,
                user=os.getenv('HBNB_MYSQL_USER'),
            ...
            self.assertIn('dominicnjoroge1@gmail.com', result)
            self.assertIn('123@Pasword_w', result)
            self.assertIn('dominicnjoroge1@gmail.com', cout.getvalue())
            self.assertIn('123@Pasword_w', cout.getvalue())
            cursor.close()
            dbc.close()
